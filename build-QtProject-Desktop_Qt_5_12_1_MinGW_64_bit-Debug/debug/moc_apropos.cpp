...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_aPropos_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_aPropos_t qt_meta_stringdata_aPropos = {
    {
QT_MOC_LITERAL(0, 0, 7) // "aPropos"
...
QT_INIT_METAOBJECT const QMetaObject aPropos::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_aPropos.data,
    qt_meta_data_aPropos,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *aPropos::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_aPropos.stringdata0))
